...
- `Comparison`: This folder contains code for our approach with a neural network parametrization of the velocity. The folder also contains code for the SINDy [2] and Neural ODE [3] approaches for learning dynamics from trajectory data, which can be used to perform comparisons. 
